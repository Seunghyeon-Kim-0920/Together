...
export const MESSAGES = {
  ko: {
    ...
    scheduleLoading: "공개 운행표를 확인하는 중", scheduleFound: "선택된 경로의 모든 구간에서 출발·도착 시간을 확인했습니다.", schedulePartial: "검증에 필요한 모든 구간을 확인하지 못했습니다.", scheduleChecked: "공개 운행표 확인을 마쳤습니다.", scheduleUnavailable: "확인된 운행표가 없습니다.", verifiedRouteUnavailable: "연결 가능한 전체 경로를 찾지 못했습니다", verifiedRouteUnavailableHelp: "확인된 구간만으로 선택한 도시를 모두 잇지 못했습니다. 현재 결과에는 철도와 장거리 버스만 포함됩니다.", transitDataCredit: "대중교통 데이터: Transitous · OpenStreetMap", selectedPeople: "{count}명 균등 분할",
  ...
  en: {
    ...
    routeTitle: "The most efficient travel route",
    ...
    scheduleLoading: "Checking published timetables", scheduleFound: "Departure and arrival times are verified for every leg in the selected route.", schedulePartial: "Not every pair required for verification could be checked.", scheduleChecked: "Published timetable check completed.", scheduleUnavailable: "No verified timetable is available.", verifiedRouteUnavailable: "No complete connecting route was found", verifiedRouteUnavailableHelp: "The verified legs do not connect every selected city. Current results include rail and long-distance coach only.", transitDataCredit: "Transit data: Transitous · OpenStreetMap", selectedPeople: "Split equally among {count} people",
  ...
  fr: {
    ...
    routeTitle: "L’itinéraire de voyage le plus efficace",
    ...
    scheduleLoading: "Consultation des horaires publiés", scheduleFound: "Les départs et arrivées de chaque trajet de l’itinéraire choisi sont vérifiés.", schedulePartial: "Toutes les liaisons nécessaires n’ont pas pu être vérifiées.", scheduleChecked: "Consultation des horaires terminée.", scheduleUnavailable: "Aucun horaire vérifié n’est disponible.", verifiedRouteUnavailable: "Aucun itinéraire complet n’a été trouvé", verifiedRouteUnavailableHelp: "Les trajets vérifiés ne relient pas toutes les villes choisies. Les résultats actuels comprennent uniquement le train et l’autocar longue distance.", transitDataCredit: "Données de transport : Transitous · OpenStreetMap", selectedPeople: "Répartition égale entre {count} personnes",
  ...
  ja: {
    ...
    scheduleLoading: "公開時刻表を確認中", scheduleFound: "選択したルートの全区間で出発・到着時刻を確認しました。", schedulePartial: "確認に必要な全区間を検証できませんでした。", scheduleChecked: "公開時刻表の確認が完了しました。", scheduleUnavailable: "確認済みの時刻表はありません。", verifiedRouteUnavailable: "全都市を結ぶルートが見つかりませんでした", verifiedRouteUnavailableHelp: "確認済みの区間だけでは選択したすべての都市を結べません。現在の結果には鉄道と長距離バスのみが含まれます。", transitDataCredit: "公共交通データ：Transitous・OpenStreetMap", selectedPeople: "{count}人で均等に分割",
  ...
  zh: {
    ...
    scheduleLoading: "正在查询公开时刻表", scheduleFound: "已核验所选路线每个区段的出发与抵达时间。", schedulePartial: "未能核验所需的全部区段。", scheduleChecked: "公开时刻表核验完成。", scheduleUnavailable: "没有可用的已核验时刻表。", verifiedRouteUnavailable: "未找到连接全部城市的路线", verifiedRouteUnavailableHelp: "已核验的区段无法连接所有所选城市。当前结果仅包含铁路和长途巴士。", transitDataCredit: "公共交通数据：Transitous · OpenStreetMap", selectedPeople: "由{count}人平均分摊",
