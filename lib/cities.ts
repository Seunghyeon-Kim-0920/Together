...
export const CITIES: readonly City[] = Object.freeze([
  ...
  {
    id: "lyon",
    names: names("리옹", "Lyon", "Lyon", "リヨン", "里昂"),
    country: { code: "FR", names: names("프랑스", "France", "France", "フランス", "法国") },
  ...
  {
    id: "brussels",
    names: names("브뤼셀", "Brussels", "Bruxelles", "ブリュッセル", "布鲁塞尔"),
    country: { code: "BE", names: names("벨기에", "Belgium", "Belgique", "ベルギー", "比利时") },
    coordinates: { latitude: 50.8503, longitude: 4.3517 },
    timeZone: "Europe/Brussels",
  },
  {
    id: "amsterdam",
    names: names("암스테르담", "Amsterdam", "Amsterdam", "アムステルダム", "阿姆斯特丹"),
    country: { code: "NL", names: names("네덜란드", "Netherlands", "Pays-Bas", "オランダ", "荷兰") },
  ...
  {
    id: "dublin",
    names: names("더블린", "Dublin", "Dublin", "ダブリン", "都柏林"),
    country: { code: "IE", names: names("아일랜드", "Ireland", "Irlande", "アイルランド", "爱尔兰") },
  ...
  {
    id: "prague",
    names: names("프라하", "Prague", "Prague", "プラハ", "布拉格"),
    country: { code: "CZ", names: names("체코", "Czechia", "Tchéquie", "チェコ", "捷克") },
    coordinates: { latitude: 50.0755, longitude: 14.4378 },
    timeZone: "Europe/Prague",
  },
  {
    id: "vienna",
    names: names("빈", "Vienna", "Vienne", "ウィーン", "维也纳"),
    country: { code: "AT", names: names("오스트리아", "Austria", "Autriche", "オーストリア", "奥地利") },
    coordinates: { latitude: 48.2082, longitude: 16.3738 },
    timeZone: "Europe/Vienna",
  },
  {
    id: "budapest",
    names: names("부다페스트", "Budapest", "Budapest", "ブダペスト", "布达佩斯"),
    country: { code: "HU", names: names("헝가리", "Hungary", "Hongrie", "ハンガリー", "匈牙利") },
    coordinates: { latitude: 47.4979, longitude: 19.0402 },
    timeZone: "Europe/Budapest",
  },
  {
    id: "tallinn",
    names: names("탈린", "Tallinn", "Tallinn", "タリン", "塔林"),
    country: { code: "EE", names: names("에스토니아", "Estonia", "Estonie", "エストニア", "爱沙尼亚") },
    coordinates: { latitude: 59.437, longitude: 24.7536 },
    timeZone: "Europe/Tallinn",
  },
  {
    id: "riga",
    names: names("리가", "Riga", "Riga", "リガ", "里加"),
    country: { code: "LV", names: names("라트비아", "Latvia", "Lettonie", "ラトビア", "拉脱维亚") },
  ...
  {
    id: "milan",
    names: names("밀라노", "Milan", "Milan", "ミラノ", "米兰"),
    country: { code: "IT", names: names("이탈리아", "Italy", "Italie", "イタリア", "意大利") },
