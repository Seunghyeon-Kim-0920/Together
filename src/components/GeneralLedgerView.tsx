...
export function GeneralLedgerView({ ledger, locale, automationStatus, pendingAutomation, automationBusy, onAutomationRefresh, onOpenAutomationSettings, onRequestAutomationAlertPermission, onToggleAllPaymentApps, onRegisterAutomationSource, onRemoveAutomationSource, onConfirmAutomationExpense, onDismissAutomationCandidate, onMove, onChange, onNotify }: { ledger: GeneralLedger; locale: Locale; automationStatus: CardAutomationStatus; pendingAutomation: readonly NativeCardCandidate[]; automationBusy: boolean; onAutomationRefresh: () => void; onOpenAutomationSettings: () => void; onRequestAutomationAlertPermission: () => void; onToggleAllPaymentApps: (enabled: boolean) => void; onRegisterAutomationSource: (source: AutomationSource) => void; onRemoveAutomationSource: (packageName: string) => void; onConfirmAutomationExpense: (candidate: NativeCardCandidate) => void; onDismissAutomationCandidate: (candidate: NativeCardCandidate) => void; onMove: (expense: GeneralExpense) => void; onChange: (ledger: GeneralLedger) => void; onNotify: Notify }) {
